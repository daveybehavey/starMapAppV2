...
- Static homepage visual/readability refinement:
  ...
  - switched the framed delivery card sample to a contrasting heart-style Printful cutout proof so the first-view delivery row shows stronger style variety
