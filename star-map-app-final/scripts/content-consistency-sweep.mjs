...
const pageChecks = [
  ...
  {
    path: "/blog/astronomy-behind-star-maps",
    requiredAny: ["astronomy", "star map", "preview"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/blog/choose-date-location-custom-star-map",
    requiredAny: ["date", "location", "star map"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/blog/custom-star-map-for-anniversary",
    requiredAny: ["anniversary", "star map", "gift"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/blog/custom-star-maps-for-weddings",
    requiredAny: ["wedding", "star map", "gift"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/blog/personalized-star-map-birthday-gift",
    requiredAny: ["birthday", "star map", "gift"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/blog/valentines-day-star-map",
    requiredAny: ["valentine", "star map", "gift"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/how-accurate-are-star-maps",
    requiredAny: ["accurate", "astronomy", "star map"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
    path: "/how-to-print-star-map",
    requiredAny: ["print", "star map", "framed"],
    requiredAll: commercePolicyLinks,
    forbiddenAny: [],
  },
  {
