/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 89d2d5da9cd2b8f397873167d066d6f9)
// Runtime types generated with workerd@1.20251210.0 2025-12-29 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		PRINT_ORDER_AUTHORITY: DurableObjectNamespace /* PrintOrderAuthorityDO */;
		...
		NEXT_PUBLIC_PRICE_CENTS: string;
		NEXT_PUBLIC_PROMO_PRICE_CENTS: string;
		NEXT_PUBLIC_PROMO_START: string;
		NEXT_PUBLIC_PROMO_END: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_INC_CACHE_R2_PREFIX" | "STRIPE_SECRET_KEY" | "NEXT_PUBLIC_SITE_URL" | "STRIPE_WEBHOOK_SECRET" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_GA_ID" | "PRICE_CENTS" | "PROMO_PRICE_CENTS" | "PROMO_START" | "PROMO_END" | "CURRENCY" | "STRIPE_PROMO_CODE_ID" | "NEXT_PUBLIC_PRICE_CENTS" | "NEXT_PUBLIC_PROMO_PRICE_CENTS" | "NEXT_PUBLIC_PROMO_START" | "NEXT_PUBLIC_PROMO_END" | "NEXT_PUBLIC_CURRENCY">> {}
}
