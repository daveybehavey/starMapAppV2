...
export const seoOccasions: SeoOccasion[] = [
  ...
  },
  {
    ...
    label: "First Home",
    intro:
      "Commemorate a first home with a star map from move‑in night or closing day.",
    detail:
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Use your move‑in date and address to create a personalized keepsake.",
      },
      {
        question: "Is the file print‑ready?",
        answer:
          "You get a high‑resolution PNG designed for framing.",
      },
      {
        question: "Do I need the exact address?",
        answer:
          "A city or neighborhood is fine. Exact coordinates are optional.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. A shared sky moment makes a meaningful, personal gift.",
      },
      {
        question: "Can I add a custom message?",
        answer:
          "You can add a dedication line and custom text.",
      },
      {
        question: "Can I include two locations?",
        answer:
          "Use the location that matches the sky you want, and include both cities in the custom text.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It’s a unique way to commemorate a major milestone.",
      },
      {
        question: "Can I include names and a message?",
        answer:
          "Add names, dates, and a short dedication before downloading.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. A personalized sky from a special date is a meaningful Valentine’s gift.",
      },
      {
        question: "Can I choose any date?",
        answer:
          "Yes. Use Valentine’s Day or any date that matters most.",
      },
      {
        question: "Is this only for couples?",
        answer:
          "No. Valentine’s star maps are also thoughtful for friends and family.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It’s personal, thoughtful, and easy to customize with names and dates.",
      },
      {
        question: "Can I add multiple names?",
        answer:
          "Yes. Add names and a short dedication in the editor.",
      },
      {
        question: "Can I use a date other than Mother’s Day?",
        answer:
          "Yes. Any meaningful family date works great.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the date and location that matter most to you.",
      },
      {
        question: "Can I use the date we first met?",
        answer:
          "Absolutely. Any meaningful date works, not just the wedding date.",
      },
    ],
  },
  {
    ...
    label: "Wedding",
    intro:
      "Create a wedding star map that captures the exact sky from your wedding night or ceremony date.",
    detail:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "You can customize the text with names, date, and location before downloading.",
      },
      {
        question: "Can I use the reception time instead of ceremony time?",
        answer:
          "Yes. Choose any time that matches the moment you want to remember.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Enter the birth location or any place that matters.",
      },
      {
        question: "Do I need the exact birth time?",
        answer:
          "Exact time is optional, but it makes the sky even more precise.",
      },
    ],
  },
  {
    ...
    label: "Baby Shower",
    intro:
      "Celebrate a baby shower with a star map that captures the sky on a meaningful date.",
    exampleLine: "Baby Shower · Chicago, IL · April 6, 2024",
    faqs: [
      {
        question: "Is a star map a good baby shower gift?",
        answer:
          "Yes. It’s a unique, personal gift that parents can treasure.",
      },
      {
        question: "Can I use the due date instead?",
        answer:
          "You can choose any date and location that matter most.",
      },
    ],
  },
  {
    ...
    label: "Housewarming",
    intro:
      "Mark a new home with a star map from the move‑in date or closing day.",
    exampleLine: "Our New Home · Raleigh, NC · October 8, 2023",
    faqs: [
      {
        question: "Is this good for housewarming gifts?",
        answer:
          "Yes. A star map is a thoughtful way to commemorate a new home milestone.",
      },
      {
        question: "Can I include the address?",
        answer:
          "You can use the city or exact location for the map’s sky calculation.",
      },
    ],
  },
  {
    ...
    label: "Baptism",
    intro:
      "Commemorate a baptism with a star map that captures the sky from the ceremony date.",
    exampleLine: "Baptism · Boston, MA · June 2, 2024",
    faqs: [
      {
        question: "Is a star map appropriate for a baptism?",
        answer:
          "Yes. It’s a meaningful keepsake for a religious milestone.",
      },
      {
        question: "Can I add a dedication?",
        answer:
          "Yes. Add a short message, names, and the date.",
      },
    ],
  },
  {
    ...
    label: "Bar Mitzvah",
    intro:
      "Celebrate a bar mitzvah with a star map that captures the sky from the ceremony date.",
    exampleLine: "Bar Mitzvah · Miami, FL · March 9, 2024",
    faqs: [
      {
        question: "Is a star map a good bar mitzvah gift?",
        answer:
          "Yes. It’s a personalized gift tied to the ceremony date and location.",
      },
      {
        question: "Can I add Hebrew text?",
        answer:
          "You can customize text in the editor, including non‑English characters.",
      },
    ],
  },
  {
    ...
    label: "Bat Mitzvah",
    intro:
      "Create a bat mitzvah star map as a memorable keepsake for the ceremony date.",
    exampleLine: "Bat Mitzvah · Los Angeles, CA · May 18, 2024",
    faqs: [
      {
        question: "Is a bat mitzvah star map unique?",
        answer:
          "Yes. It’s a thoughtful keepsake with the exact sky from the ceremony date.",
      },
      {
        question: "Can I personalize the dedication?",
        answer:
          "You can add names, date, and a dedication line before download.",
      },
    ],
  },
  {
    ...
    label: "Sweet 16",
    intro:
      "Celebrate a Sweet 16 with a star map from the birthday date or party night.",
    exampleLine: "Sweet 16 · Dallas, TX · August 16, 2023",
    faqs: [
      {
        question: "Is a star map fun for Sweet 16 gifts?",
        answer:
          "Yes. It’s a unique, personalized gift that stands out from typical presents.",
      },
      {
        question: "Can I use the party date?",
        answer:
          "Yes. Use any date and location you want to capture.",
      },
    ],
  },
  {
    ...
    label: "Quinceañera",
    intro:
      "Honor a quinceañera with a star map that captures the sky from the celebration date.",
    exampleLine: "Quinceañera · San Antonio, TX · September 14, 2024",
    faqs: [
      {
        question: "Is a star map good for quinceañera gifts?",
        answer:
          "Yes. It’s a meaningful, personalized keepsake for a major milestone.",
      },
      {
        question: "Can I include names and the venue?",
        answer:
          "You can add names, date, and a custom location line.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It’s a thoughtful way to capture a meaningful moment in your relationship.",
      },
      {
        question: "Can I choose any date and place?",
        answer:
          "Yes. Use the date and location that matter most.",
      },
    ],
  },
  {
    ...
    label: "First Kiss",
    intro:
      "Celebrate your first kiss with a star map that captures the sky from that night.",
    exampleLine: "Our First Kiss · Paris, France · July 22, 2017",
    faqs: [
      {
        question: "Is this a good romantic gift?",
        answer:
          "Yes. A first kiss star map is a unique, personal gift for partners.",
      },
      {
        question: "Can I include a short message?",
        answer:
          "You can add a dedication line in the editor.",
      },
    ],
  },
  {
    ...
    intro:
      "Mark your first anniversary with a star map from the wedding date or celebration night.",
    exampleLine: "First Anniversary · Austin, TX · June 21, 2025",
    faqs: [
      {
        question: "Is a first anniversary star map special?",
        answer:
          "Yes. It captures a meaningful milestone with the exact night sky.",
      },
      {
        question: "Can I use the wedding date?",
        answer:
          "You can choose any date you want to commemorate.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Star maps are personal and stand out during the holidays.",
      },
      {
        question: "Can I use any holiday date?",
        answer:
          "Yes. Pick the date that matters most to your family.",
      },
    ],
  },
  {
    ...
    label: "New Year",
    intro:
      "Celebrate New Year’s with a star map that captures the sky from a memorable night.",
    exampleLine: "New Year’s Eve · Sydney, AU · December 31, 2024",
    faqs: [
      {
        question: "Is a New Year star map meaningful?",
        answer:
          "Yes. It captures a once‑a‑year moment and makes a great gift.",
      },
      {
        question: "Can I use New Year’s Eve or Day?",
        answer:
          "Yes. Use any time and location you want to memorialize.",
      },
    ],
  },
  {
    ...
    label: "Moving Away",
    intro:
      "Commemorate a move with a star map from your last night or farewell date.",
    exampleLine: "Until We Meet Again · San Francisco, CA · August 15, 2023",
    faqs: [
      {
        question: "Is this good for a farewell gift?",
        answer:
          "Yes. It’s a heartfelt way to remember a place and time.",
      },
      {
        question: "Can I include a message?",
        answer:
          "You can add a dedication line before downloading.",
      },
    ],
  },
  {
    ...
    label: "Promotion",
    intro:
      "Celebrate a promotion with a star map from the day it happened.",
    exampleLine: "Promotion Day · Atlanta, GA · October 3, 2024",
    faqs: [
      {
        question: "Is a star map a good promotion gift?",
        answer:
          "Yes. It’s a unique way to mark a career milestone.",
      },
      {
        question: "Can I add a title or role?",
        answer:
          "You can customize the text with any title or message.",
      },
    ],
  },
  {
    ...
    label: "Team Win",
    intro:
      "Celebrate a team win or championship with a star map of the victory night.",
    exampleLine: "Championship Night · Miami, FL · June 7, 2024",
    faqs: [
      {
        question: "Is this good for sports teams?",
        answer:
          "Yes. It’s a creative keepsake for a big win.",
      },
      {
        question: "Can I add team names?",
        answer:
          "You can customize the text with team names and dates.",
      },
    ],
  },
  {
    ...
    intro:
      "Mark a 30th, 40th, or 50th birthday with a star map from the celebration night.",
    exampleLine: "40th Birthday · Orlando, FL · April 12, 2024",
    faqs: [
      {
        question: "Is this good for milestone birthdays?",
        answer:
          "Yes. It’s a meaningful way to commemorate a big birthday.",
      },
      {
        question: "Can I use a specific party date?",
        answer:
          "Yes. Use the date that matters most.",
      },
    ],
  },
  {
    ...
    label: "Pet Memorial",
    intro:
      "Honor a beloved pet with a memorial star map tied to a meaningful date.",
    exampleLine: "In Loving Memory · Denver, CO · March 2, 2022",
    faqs: [
      {
        question: "Is a pet memorial star map appropriate?",
        answer:
          "Yes. It’s a gentle way to remember a pet and a special date.",
      },
      {
        question: "Can I add my pet’s name?",
        answer:
          "You can add names and a dedication line before download.",
      },
    ],
  },
  {
    ...
    label: "Friendship",
    intro:
      "Celebrate friendship with a star map that captures a shared date and place.",
    exampleLine: "Best Friends · Nashville, TN · July 4, 2021",
    faqs: [
      {
        question: "Is a star map good for a friend?",
        answer:
          "Yes. It’s a unique and thoughtful gift for close friends.",
      },
      {
        question: "Can I customize the message?",
        answer:
          "You can add a personal dedication line before downloading.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It’s personal, thoughtful, and tied to a date that matters to your family.",
      },
      {
        question: "Can I use any date instead of Father's Day?",
        answer:
          "Yes. Use a birthday, anniversary, or any memorable moment.",
      },
    ],
  },
  {
    ...
    intro:
      "Honor grandparents with a star map from a family milestone or shared celebration.",
    exampleLine: "For Grandma & Grandpa · Omaha, NE · September 8, 2024",
    faqs: [
      {
        question: "Is this a good Grandparents Day gift?",
        answer:
          "Yes. It’s a unique keepsake that celebrates family history and milestones.",
      },
      {
        question: "Can I include multiple names?",
        answer:
          "Yes. Add multiple names and a short dedication in the editor.",
      },
    ],
  },
  {
    ...
    label: "Bridal Shower",
    intro:
      "Create a bridal shower star map that captures the sky from the celebration date.",
    exampleLine: "Bridal Shower · Charleston, SC · April 20, 2024",
    faqs: [
      {
        question: "Is a star map a good bridal shower gift?",
        answer:
          "Yes. It’s a personal, elegant gift that feels unique to the couple.",
      },
      {
        question: "Can I add the couple’s names?",
        answer:
          "Yes. Customize the text with names and a special message.",
      },
    ],
  },
  {
    ...
    intro:
      "Capture the engagement party night with a star map that matches the exact sky.",
    exampleLine: "Engagement Party · Scottsdale, AZ · August 10, 2024",
    faqs: [
      {
        question: "Is this different from an engagement star map?",
        answer:
          "Yes. It focuses on the party date, while engagement maps focus on the proposal date.",
      },
      {
        question: "Can I customize the event name?",
        answer:
          "Yes. Edit the title to match your celebration.",
      },
    ],
  },
  {
    ...
    label: "Adoption Day",
    intro:
      "Celebrate adoption day (or gotcha day) with a star map from that special moment.",
    exampleLine: "Adoption Day · Minneapolis, MN · November 12, 2022",
    faqs: [
      {
        question: "Is this appropriate for adoption day?",
        answer:
          "Yes. It’s a meaningful way to honor a life-changing family milestone.",
      },
      {
        question: "Can I include a child’s name?",
        answer:
          "Yes. Add names and a dedication line before downloading.",
      },
    ],
  },
  {
    ...
    intro:
      "Celebrate a first birthday with a star map from the birth date or party night.",
    exampleLine: "First Birthday · Tampa, FL · July 1, 2024",
    faqs: [
      {
        question: "Can I use the birth date or party date?",
        answer:
          "Yes. Choose the date and location that mean the most to you.",
      },
      {
        question: "Is this a good first birthday gift?",
        answer:
          "Yes. It’s a sentimental keepsake parents can treasure.",
      },
    ],
  },
  {
    ...
    intro:
      "Mark a work anniversary with a star map from the milestone date.",
    exampleLine: "Work Anniversary · Seattle, WA · March 5, 2024",
    faqs: [
      {
        question: "Is a star map good for a coworker?",
        answer:
          "Yes. It’s a thoughtful, professional gift for a career milestone.",
      },
      {
        question: "Can I include a company name or role?",
        answer:
          "Yes. Add a title, company name, or custom line in the editor.",
      },
    ],
  },
  {
    ...
    label: "New Job",
    intro:
      "Celebrate a new job with a star map from the first day or offer date.",
    exampleLine: "New Job · Denver, CO · October 2, 2023",
    faqs: [
      {
        question: "Is this good for a new job gift?",
        answer:
          "Yes. It’s a unique way to mark a fresh start and career milestone.",
      },
      {
        question: "Can I use the first day date?",
        answer:
          "Yes. Use the first day, offer date, or any meaningful moment.",
      },
    ],
  },
  {
    ...
    intro:
      "Remember a family reunion with a star map from the gathering night.",
    exampleLine: "Family Reunion · Asheville, NC · July 20, 2024",
    faqs: [
      {
        question: "Is this good for a family reunion gift?",
        answer:
          "Yes. It’s a unique keepsake that celebrates time together.",
      },
      {
        question: "Can I include family names?",
        answer:
          "Yes. Add names or a family dedication line.",
      },
    ],
  },
  {
    ...
    label: "Travel Memory",
    intro:
      "Capture a favorite trip with a star map from the night you were there.",
    exampleLine: "Paris Trip · Paris, France · May 9, 2023",
    faqs: [
      {
        question: "Can I make a star map from a vacation?",
        answer:
          "Yes. Use the date and location from any trip you want to remember.",
      },
      {
        question: "Is this good for couples travel gifts?",
        answer:
          "Yes. It’s a romantic way to remember a shared adventure.",
      },
    ],
  },
  {
    ...
    intro:
      "Celebrate a homecoming with a star map from the night they returned.",
    exampleLine: "Welcome Home · Norfolk, VA · January 18, 2024",
    faqs: [
      {
        question: "Is this a good military homecoming gift?",
        answer:
          "Yes. It’s a meaningful way to commemorate a long-awaited return.",
      },
      {
        question: "Can I add a unit name or message?",
        answer:
          "Yes. Customize the text with a unit, rank, or personal note.",
      },
    ],
  },
  {
    ...
    intro:
      "Thank a teacher with a star map that celebrates a memorable school year.",
    exampleLine: "Thank You · Austin, TX · May 24, 2024",
    faqs: [
      {
        question: "Is a star map good for teacher appreciation?",
        answer:
          "Yes. It’s a thoughtful gift that feels personal and unique.",
      },
      {
        question: "Can I add a student name or class year?",
        answer:
          "Yes. Add names, a class year, or a short message.",
      },
    ],
  },
  {
    ...
    intro:
      "Celebrate a home anniversary with a star map from move-in day or closing.",
    exampleLine: "Home Anniversary · Denver, CO · September 2, 2023",
    faqs: [
      {
        question: "Is this good for a home anniversary?",
        answer:
          "Yes. It’s a meaningful keepsake for a home milestone.",
      },
      {
        question: "Can I use a different date?",
        answer:
          "Yes. Use any date that marks your time in the home.",
      },
    ],
  },
];
