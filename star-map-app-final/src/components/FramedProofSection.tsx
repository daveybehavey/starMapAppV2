        ...
        <div className="space-y-4 p-6">
          <div className="space-y-2">
            <div className="flex flex-wrap gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-amber-900/90">
              ...
              <span className="rounded-full border border-black/10 bg-white/85 px-3 py-1 text-[#4f5a73]">Quality check before production</span>
            </div>
          ...
          <ul className="space-y-2 text-sm text-neutral-800">
            ...
            <li className="brand-light-card rounded-2xl px-4 py-3">
              Paid print orders get a manual quality check before production starts.
            </li>
            <li className="brand-light-card rounded-2xl px-4 py-3">
