...
export default function PhysicalProductGallerySection({
  ...
  const galleryCards = [
    ...
    {
      src: "/printproof/gallery/graduation-unframed-cutout.webp",
      fallbackSrc: "/printproof/gallery/graduation-unframed.jpg",
      alt: "Unframed StarMapCo print proof shown in-room",
      eyebrow: "Unframed · Alternate",
      title: "Second unframed room view",
      detail: "Extra unframed context gives buyers another real-world reference before checkout.",
      ...
      artWrapClass:
        "absolute inset-[11%] z-10 overflow-hidden border border-black/10 bg-transparent shadow-[0_14px_22px_rgba(0,0,0,0.2)]",
      imageClass: "object-contain scale-[1.08]",
      eyebrowClass: "text-slate-700",
      artWrapStyle: undefined as CSSProperties | undefined,
    },
