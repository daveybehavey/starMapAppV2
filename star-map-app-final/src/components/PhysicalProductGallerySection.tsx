...
export default function PhysicalProductGallerySection({
  ...
  const galleryCards = [
    ...
    },
    {
      ...
      fallbackSrc: "/printproof/gallery/wedding-framed.jpg",
      alt: "Framed StarMapCo birthday print proof shown in-room",
      eyebrow: "Framed · Alternate",
      title: "Second framed room view",
      detail: "Extra framed context gives buyers another real-world reference before checkout.",
