    ...
    <main className="mx-auto max-w-5xl px-4 pb-12 pt-10 sm:pt-14">
      ...
      <header className="space-y-3 text-center">
        ...
        <p className="text-sm text-white/90 sm:text-base">
          Start with one preview, then choose your delivery format. This page is only for the live formats you can buy now.
        </p>
      </header>
      ...
      <section className="content-visibility-auto mt-6 space-y-4 rounded-3xl border border-black/5 bg-white/90 p-6 shadow-xl shadow-black/10">
        <h2 className="text-lg font-semibold text-midnight">How to choose quickly</h2>
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-black/10 bg-amber-50/70 p-4">
            <h3 className="text-sm font-semibold text-midnight">Fastest</h3>
            <p className="mt-1 text-xs text-neutral-700">Choose HD digital if you need the file right away or want to print locally.</p>
          </div>
          <div className="rounded-2xl border border-black/10 bg-amber-50/70 p-4">
            <h3 className="text-sm font-semibold text-midnight">Best gift</h3>
            <p className="mt-1 text-xs text-neutral-700">Choose framed print if presentation matters most and you want the strongest gift-ready finish.</p>
          </div>
          <div className="rounded-2xl border border-black/10 bg-amber-50/70 p-4">
            <h3 className="text-sm font-semibold text-midnight">Lower physical cost</h3>
            <p className="mt-1 text-xs text-neutral-700">Choose unframed print if you already have a frame plan and just want the poster delivered.</p>
          </div>
        </div>
        <p className="text-xs text-neutral-700">
          Current print coverage: {printCountryCount} shipping countries. Print orders can still add the HD file for{" "}
