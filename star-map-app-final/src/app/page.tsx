      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: `Free preview lets you confirm the date, location, and layout first. Paid checkout can unlock framed print (${printFramedLabel}), unframed print (${printUnframedOfferLabel}), or HD digital delivery from ${priceLabel}.`,
            },
          },
          {
            "@type": "Question",
