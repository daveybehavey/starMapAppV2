    ...
    <main className="mx-auto max-w-4xl px-4 pt-10 pb-12 sm:pt-14">
      <header className="space-y-3 text-center">
        ...
        <p className="text-sm text-white/90 sm:text-base">
          Create a custom star map for {display} and capture the exact night sky from your date and location.
          Preview instantly, then choose framed print, unframed print, or HD digital delivery from the same
          design.
        </p>
      ...
      <section className="content-visibility-auto mt-8 space-y-4 rounded-3xl border border-black/5 bg-white/90 p-6 shadow-xl shadow-black/10">
        <h2 className="text-midnight text-xl font-semibold">
          A star map that matches your moment in {display}
        </h2>
        <p className="text-sm leading-relaxed text-neutral-700 sm:text-base">
          The night sky changes throughout the year. Your map is calculated from real astronomical data so the
          stars and constellations match your exact date and location in {display}.
        </p>
      ...
      <section className="content-visibility-auto mt-6 space-y-3 rounded-3xl border border-black/5 bg-amber-50/80 p-6 shadow-inner shadow-black/5">
        <h2 className="text-midnight text-lg font-semibold">Start your {display} star map</h2>
        <ol className="list-decimal space-y-2 pl-5 text-sm text-neutral-700 sm:text-base">
          ...
          <li>
            Continue into framed print, unframed print, or HD digital delivery once the preview looks right
          </li>
        </ol>
        <div className="pt-2">
          <Link
      ...
      <section className="content-visibility-auto mt-6 space-y-3 rounded-3xl border border-black/5 bg-white/90 p-6 shadow-xl shadow-black/10">
        <h2 className="text-midnight text-lg font-semibold">Related locations</h2>
        <p className="text-sm text-neutral-700 sm:text-base">Browse nearby and popular cities:</p>
      ...
      <section className="content-visibility-auto mt-6 space-y-4 rounded-3xl border border-black/5 bg-white/90 p-6 shadow-xl shadow-black/10">
        <h2 className="text-midnight text-lg font-semibold">Star map in {display} FAQ</h2>
        <div className="space-y-4 text-sm text-neutral-700 sm:text-base">
          <div>
            <h3 className="text-midnight font-semibold">Can I create a star map for {display}?</h3>
            <p>Yes. Enter any date and time, and the map will render the accurate night sky for {display}.</p>
          </div>
          <div>
            <h3 className="text-midnight font-semibold">Is the {display} star map print‑ready?</h3>
            <p>The HD export is a high‑resolution PNG designed for printing and framing.</p>
          </div>
        </div>
      </section>
