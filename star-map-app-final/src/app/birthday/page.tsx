...
export const metadata: Metadata = {
  ...
  description:
    "Celebrate a birthday with a personalized star map showing the exact night sky from their special date and place. Choose HD plus U.S. unframed and framed print checkout.",
  alternates: { canonical: `${siteUrl}/birthday` },
  openGraph: {
    title: "Personalized Birthday Star Map | StarMapCo",
    description: "Capture the night sky from their birthday with HD plus U.S. unframed and framed print options.",
