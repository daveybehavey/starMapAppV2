...
> = {
  poster_framed: {
    ...
    detail: "Ready-to-hang framed print that already feels like the finished gift.",
    bestFor: "Use for premium gifting",
  ...
  poster_unframed: {
    ...
    detail: "Lower-cost poster route if you already have a frame plan.",
    bestFor: "Use for lower-cost physical delivery",
  ...
  canvas_wrap: {
    ...
    bestFor: "Use for cozy, modern walls",
    sceneClass: "proof-wall-stage proof-wall-stage--gallery",
    imageClass: "proof-wall-image object-contain px-5 py-6 sm:px-6 sm:py-7",
  },
  mug_11oz: {
    ...
    bestFor: "Use for coffee and tea lovers",
    sceneClass: "proof-wall-stage proof-wall-stage--tabletop",
    imageClass: "proof-wall-image object-contain px-5 py-6 sm:px-6 sm:py-7",
  },
  card_4x6: {
    ...
    bestFor: "Use for anniversaries and thank-yous",
    sceneClass: "proof-wall-stage proof-wall-stage--tabletop",
    imageClass: "proof-wall-image object-contain px-5 py-6 sm:px-6 sm:py-7",
  },
};
