...
> = {
  poster_framed: {
    ...
    detail: "Ship this exact map as a framed print — same design you approved, ready to hang.",
    bestFor: "Best when you want a finished gift on the wall",
  ...
  poster_unframed: {
    ...
    detail: "Print this map unframed if you already have a frame or want a lower total.",
    bestFor: "Best when you will frame it yourself",
